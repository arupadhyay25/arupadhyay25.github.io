    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right">
          Hi, I am <span className="about__name">Abhishek Upadhyay</span>
        </h1>
        <Type />
        ...
        <div className="about__contact center">
          ...
          <a
            href="https://www.facebook.com/abhishek.upadhyay.5492/"
            aria-label="github"
            className="link link--icon"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://goo.gl/maps/XiC2rcy76fGkrcgL9"
            aria-label="github"
            className="link link--icon"
            target="_blank"
            rel="noreferrer"
